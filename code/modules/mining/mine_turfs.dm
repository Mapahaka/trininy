...
/turf/simulated/floor/proc/fullUpdateMineralOverlays()
	...
	for(var/direcrion in alldirs)
		if(istype(get_step(src, direcrion), /turf/simulated/floor))
			A = get_step(src, direcrion)
