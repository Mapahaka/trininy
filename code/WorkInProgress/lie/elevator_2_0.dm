...
/obj/machinery/computer/elevator_control/attack_hand(user as mob)
	...
	var/dat = text("<center>Elevator's contorl:<br> <b><A href='?src=\ref[src];move=0'>0 : Technical floor</A></b></center>")
	dat += text("<center><b><A href='?src=\ref[src];move=1'>G : Cargo doc</A></b></center>")
